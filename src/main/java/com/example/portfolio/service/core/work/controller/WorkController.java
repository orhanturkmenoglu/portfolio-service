...
public class WorkController {
    ...
    @PostMapping
    public ResponseEntity<BaseResponse<WorkResponseDTO>> createWork(@Valid @RequestBody WorkRequestDTO dto) {
        WorkResponseDTO created = workService.createWork(dto);
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(BaseResponse.success(created, "Work experience created successfully", HttpStatus.CREATED.value()));
    }
    ...
    public ResponseEntity<BaseResponse<List<WorkResponseDTO>>> getAllWorks() {
        ...
        return ResponseEntity.ok(BaseResponse.success(list, "Fetched all work experiences", HttpStatus.OK.value()));
    }
    ...
    @GetMapping("/{id}")
    public ResponseEntity<BaseResponse<WorkResponseDTO>> getWorkById(@PathVariable String id) {
        WorkResponseDTO dto = workService.getWorkById(id);
        return ResponseEntity.ok(BaseResponse.success(dto, "Fetched work experience", HttpStatus.OK.value()));
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<BaseResponse<WorkResponseDTO>> updateWork(@PathVariable String id, @Valid @RequestBody WorkRequestDTO dto) {
        WorkResponseDTO updated = workService.updateWorkById(id, dto);
        return ResponseEntity.ok(BaseResponse.success(updated, "Work experience updated successfully", HttpStatus.OK.value()));
    }
    ...
    @DeleteMapping("/{id}")
    public ResponseEntity<BaseResponse<Void>> deleteWork(@PathVariable String id) {
